...
class Style
{
     ...
     */
    function set_media_queries(array $media_queries): void
    {
     ...
     * @return array
     */
    function get_media_queries(): array
    {
     ...
     * @param Frame $frame
     */
    function set_frame(Frame $frame): void
    {
        $this->_frame = $frame;
    }
     ...
     * @param int $origin
     */
    function set_origin(int $origin): void
    {
        $this->_origin = $origin;
    }
     ...
     * @link https://www.w3.org/TR/CSS21/box.html#border-shorthand-properties
     */
    protected function _get_outline()
    {
     ...
     */
    protected function _get_border_spacing($computed)
    {
    ...
    protected function compute_style_side_type(string $style, string $side, string $type, $val)
    {
        ...
        if ($type === "color") {
            ...
            if ($val_computed === null) {
                ...
                return $has_line_style ? $val_computed : 0;
            }
